// METHOD 1
//(string, number, boolean, object, function, array, campuran)

let nilai = [
  { nama: "rudi", ipa: 90, bahasa: 70, matematika: 70 },
  { nama: "muklas", ipa: 80, bahasa: 90, matematika: 60 },
  { nama: "iwan", ipa: 75, bahasa: 70, matematika: 90 },
  { nama: "desi", ipa: 90, bahasa: 80, matematika: 90 },
];
let nama = ["rudi", "muklas", "iwan", "desi"];
// nama.push("kuncoro", "dayat");
// nama.unshift("budi", "udin");
// console.log(nama.splice(5, 2));
// console.log(nama.slice(0, 3));
// console.log(nilai.shift());
// console.log(nama.pop());
// console.log(nilai)[0].nama;
// console.log(nama[rudi]);
